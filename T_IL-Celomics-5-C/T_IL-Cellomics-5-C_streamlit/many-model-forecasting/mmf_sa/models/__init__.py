...
class ModelRegistry:
    ...
    def get_model(
        ...
        spark=None,
        device: str = "cpu",  # ← NEW: allow passing in device explicitly
        ...
        # ← NEW: inject device into model_conf (e.g., "cpu" or "cuda:0")
        model_conf = OmegaConf.merge(model_conf, {"device": device})
