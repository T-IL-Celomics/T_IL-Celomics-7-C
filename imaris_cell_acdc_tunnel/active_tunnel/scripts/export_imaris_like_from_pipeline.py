...
─────────────────────────────────────
--imaris-offset-x-px  default +9.0   (validated offset for this dataset)
--imaris-offset-y-px  default -10.0  (validated offset for this dataset)
--time-index-start    default 0      (ACDC frame 0 → Time=0, matches Imaris)
"""
...
def main():
    ...
    ap.add_argument("--imaris-offset-x-px", type=float, default=9.0)
    ap.add_argument("--imaris-offset-y-px", type=float, default=-10.0)
    ap.add_argument("--imaris-offset-z-px", type=float, default=0.0)
    ap.add_argument("--time-index-start", type=int, default=0,
                    help="Time index of the first frame in output Excel. "
                         "Default=1: ACDC frame 0 → Time=1, matching Imaris convention. "
